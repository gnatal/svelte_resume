<script>
  ...
  const loginForm = form(mail, password)
...
<div class="rounded-xl md:rounded-2xl md:w-1/2 w-5/6  p-5 m-auto my-[40px] md:my-[80px]  login_container">
  <div class="mx-auto py-2 text-center">
    <h2 class="text-xl font-bold">Entre e gere seu curriculum</h2>
    <span class="text-sm">ou</span>
    <p><a class="link" href="/signup"> Clique aqui para se cadastrar</a> </p> 
  </div>
